                          ...
                          193,),
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(color: isDark ?   Color(0xFF000F30) : Color(0xFFF4F7FF),),width: 343,height: 40,
                                child: Row(
                                  mainAxisAlignment :MainAxisAlignment.spaceBetween,

                                  children: [Text('${stremPRovider.tasks[index].title}',style: isDark? Theme.of(context).textTheme.labelLarge!.copyWith(color: Colors.white
